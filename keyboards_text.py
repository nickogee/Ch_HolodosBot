...
TEXTS = {
    ...
    'begin': '🗿 Начать',
    'choise_city': '🌆 Выберите город',
    'wait': '🕐 Ждите...',
    'select_skript': '🎚 Выберите действие',
    'select_wh': 'Выберите склад в городе ',
    ...
    'error_not_num': '🎲 Укажите количество - только цифры',
    'error_count': '📛 Указанное количество больше остатка товара',
    'error_not_wh': '📛 Произошла ошибка взаимодействия с севером. Начните процедуру снова.',
    'error_users_data': '📛 Произошла ошибка взаимодействия с севером. Начните процедуру снова.',
}
